        ...
        <nav className="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a href="#" className="flex items-center">
                    <img src="./logo.png" className="h-6 mr-3 sm:h-9 font-bold" alt="Beyond Bequest Logo" />
                    <span className="self-center text-2xl whitespace-nowrap dark:text-white font-bold">BEYOND<br />
                        BEQUEST</span>
                </a>
                <div className="flex items-center lg:order-2">
                    {/* <!-- <div className="hidden mt-2 mr-4 sm:inline-block">
                        <a className="github-button" href="https://github.com/themesberg/landwind" data-size="large"
                            data-icon="octicon-star" data-show-count="true"
                            aria-label="Star themesberg/landwind on GitHub">Register</a>
                    </div> --> */}
                    <a href="#"
                        className="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-lg px-4 lg:px-5 py-20 lg:py-2.5 sm:mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800 shadow-lg">Login</a>
                    <a href="#"
                        className="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-lg px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 dark:hover:bg-gray-900 focus:outline-none dark:focus:ring-gray-800 shadow-lg">Register</a>
                ...
                <div className="items-center justify-between hidden w-6/12 lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        ...
                        <li>
                            <a href="#"
                                className="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">About
                                Us</a>
                        </li>
                        <li>
                            <a href="#"
        ...
        <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div className="mr-auto place-self-center lg:col-span-7">
                <h1
                    ...
                    Building digital <br />wills.</h1>
                <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                    Beyond Bequest helps the elderly and ailing. Everybody knows when their time has come to start
                    managing their assets and planning their will. Beyond Bequest helps in these times.</p>
                <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    <a href="https://github.com/tanishach03/Beyond-Bequest"
                        ...
                        <svg className="w-4 h-4 mr-2 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 496 512">Font Awesome Pro 5.15.4 by @fontawesome - https://fontawesome.com
            ...
            <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="https://cdn.openpr.com/T/1/T130400540_g.jpg" alt="hero image" />
            </div>
        </div>
    </section>
    {/* <!-- End block -->
        ...
        <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <div className="text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 className="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Problems in
                        present-day system</h2>
                    ...
                    <ul role="list" className="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                        <li className="flex space-x-3">
                            ...
                            <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">Presence of
                                third-person (advocate)</span>
                        </li>
                        <li className="flex space-x-3">
                            {/* <!-- Icon --> */}
                            ...
                            <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">Absence of
                                digital proofs of will distribution</span>
                        </li>
                        <li className="flex space-x-3">
                            {/* <!-- Icon --> */}
                            <svg className="flex-shrink-0 w-5 h-5 text-purple-500 dark:text-purple-400" fill="currentColor"
                            ...
                            <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">Forgery or
                        ...
                        <li className="flex space-x-3">
                            ...
                            <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">Holographic
                                or oral wills</span>
                        </li>
                    </ul>
                ...
                <img className="hidden w-max mb-4 rounded-t-xl lg:mb-0 lg:flex"
                    src="https://mcmscache.epapr.in/post_images/website_350/post_15668863/thumb.jpg"
                    alt="dashboard feature image" />
            </div>
            {/* <!-- Row --> */}
            <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                {/* <img className="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex"
                    src="https://as1.ftcdn.net/v2/jpg/03/70/99/02/1000_F_370990232_6sXrqRsqBc9Of9sV7u9XWYRB6o9IJ3kF.jpg"
                    alt="feature image 2"> */}
                <div className="text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 className="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Distinctive
                        features</h2>
                    <p className="mb-8 font-light lg:text-xl">Delivering great service experiences fast - without the
                        complexity of traditional solutions.</p>
                    {/* <!-- List --> */}
                    <ul role="list" className="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                        <li className="flex space-x-3">
                            <svg className="flex-shrink-0 w-5 h-5 text-purple-500 dark:text-purple-400" fill="currentColor"
                            ...
                            <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">It lets the
                                user create distribution plan of their will whenever they see fit.</span>
                        </li>
                        {/* <!-- <li className="flex space-x-3">
                            <svg className="flex-shrink-0 w-5 h-5 text-purple-500 dark:text-purple-400" fill="currentColor"
                                viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">There is a
                                contract which contains terms and conditions.</span>
                        </li> --> */}
                        <li className="flex space-x-3">
                            {/* <!-- Icon --> */}
                            <svg className="flex-shrink-0 w-5 h-5 text-purple-500 dark:text-purple-400" fill="currentColor"
                            ...
                            <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">It enables
                                the user to add the legal details of their potential heirs.</span>
                        </li>
                        <li className="flex space-x-3">
                            {/* <!-- Icon --> */}
                            <svg className="flex-shrink-0 w-5 h-5 text-purple-500 dark:text-purple-400" fill="currentColor"
                            ...
                            <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">Using the
                                user's e-signature, the agreement will be validated.</span>
                        </li>
                        <li className="flex space-x-3">
                            {/* <!-- Icon --> */}
                            <svg className="flex-shrink-0 w-5 h-5 text-purple-500 dark:text-purple-400" fill="currentColor"
                            ...
                            <span className="text-base font-medium leading-tight text-gray-900 dark:text-white">It's
                                reliable as it is decentralized.</span>
                        </li>
                    </ul>
                    <p className="font-light lg:text-xl">Accelerate critical development work, eliminate toil,
                        and initiate changes with ease.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section className="bg-gray-50 dark:bg-gray-800">
        <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
            <figure className="max-w-screen-md mx-auto">
                ...
                <blockquote>
                    <p className="text-xl font-medium text-gray-900 md:text-2xl dark:text-white">"A blockchain-based
                        approach to increase efficiency and prevent frauds.Thus, a safer was to pass on your assets."
                    </p>
                </blockquote>
        ...
        <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
                ...
                <div>
                    ...
                    <ul className="text-gray-500 dark:br-gray-400">
                        <li className="mb-4">
            ...
            <div className="text-center">
                ...
                <span className="block text-sm text-center text-gray-500 dark:text-gray-400">© 2021-2022 Landwind™. All
